...
const app = new Vue({
    ...
    methods: {
        fetchMessages() {
            ...
            axios.get('https://alegralabs.com/abhijit/laravel-chat/public/messages',config).then(response => {
        ...
        addMessage(message) {
            ...
            axios.post('https://alegralabs.com/abhijit/laravel-chat/public/messages', message,config).then(response => {
